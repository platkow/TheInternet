...
public class EnvironmentProperty {
    ...
    private static String initAppEnv() {
        return PropertyStore.ENVIRONMENT.isSpecified() ? PropertyStore.ENVIRONMENT.getPropertyValue() : "";
    }
    ...
    private static void setSystemPropertiesFromPathUrl(String dirName) {
        ...
        if (url != null) {
            ...
            logger.warn("No such property directory '{}' present in the resources.");
        }
    }
